...
namespace app\kernel\view\driver;

use app\kernel\Container;
use app\kernel\exception\TemplateNotFoundException;
use app\kernel\Loader;
use app\kernel\Template;
...
class Think
{
    ...
    {
        $rule = [$request->action(true), parse_name($request->action(true)), $request->action()];
