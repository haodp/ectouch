...
/**
 * @see \app\kernel\Request
 * @mixin \app\kernel\Request
 * @method void hook(mixed $method, mixed $callback = null) static Hook 方法注入
 * @method \app\kernel\Request create(string $uri, string $method = 'GET', array $params = [], array $cookie = [], array $files = [], array $server = [], string $content = null) static 创建一个URL请求
