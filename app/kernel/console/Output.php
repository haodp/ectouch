...
use Exception;
use app\kernel\console\output\Ask;
use app\kernel\console\output\Descriptor;
use app\kernel\console\output\driver\Buffer;
use app\kernel\console\output\driver\Console;
use app\kernel\console\output\driver\Nothing;
use app\kernel\console\output\Question;
use app\kernel\console\output\question\Choice;
use app\kernel\console\output\question\Confirmation;

/**
 * Class Output
 * @package app\kernel\console
 *
 * @see     \app\kernel\console\output\driver\Console::setDecorated
 * @method void setDecorated($decorated)
 *
 * @see     \app\kernel\console\output\driver\Buffer::fetch
 * @method string fetch()
 *
...
class Output
{
    ...
    {
        $class = '\\app\\kernel\\console\\output\\driver\\' . ucwords($driver);
