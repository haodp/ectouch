...
/**
 * @see \app\kernel\Cache
 * @mixin \app\kernel\Cache
 * @method \app\kernel\cache\Driver connect(array $options = [], mixed $name = false) static 连接缓存
 * @method \app\kernel\cache\Driver init(array $options = []) static 初始化缓存
 * @method \app\kernel\cache\Driver store(string $name = '') static 切换缓存类型
