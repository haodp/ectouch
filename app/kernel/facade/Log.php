...
/**
 * @see \app\kernel\Log
 * @mixin \app\kernel\Log
 * @method \app\kernel\Log init(array $config = []) static 日志初始化
 * @method mixed getLog(string $type = '') static 获取日志信息
 * @method \app\kernel\Log record(mixed $msg, string $type = 'info', array $context = []) static 记录日志信息
 * @method \app\kernel\Log clear() static 清空日志信息
 * @method \app\kernel\Log key(string $key) static 当前日志记录的授权key
