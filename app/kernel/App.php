...
use app\kernel\exception\ClassNotFoundException;
...
class App implements \ArrayAccess
{
    ...
    public function init($module = '')
    {
        ...
        if (is_file($path . 'init.php')) {
            ...
            if ('' == $module) {
                // 加载系统助手函数
                include $this->thinkPath . 'support/helper.php';
            }
    ...
    public function parseClass($module, $layer, $name, $appendSuffix = false)
    {
        ...
        $array = explode('\\', $name);
        $class = parse_name(array_pop($array), 1) . ($this->suffix || $appendSuffix ? ucfirst($layer) : '');
