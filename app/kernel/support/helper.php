...
use app\kernel\exception\HttpResponseException;
use app\kernel\facade\Cache;
use app\kernel\facade\Config;
use app\kernel\facade\Cookie;
use app\kernel\facade\Debug;
use app\kernel\facade\Env;
use app\kernel\facade\Hook;
use app\kernel\facade\Lang;
use app\kernel\facade\Log;
use app\kernel\facade\Request;
use app\kernel\facade\Route;
use app\kernel\facade\Session;
use app\kernel\facade\Url;
use app\kernel\Response;
use app\kernel\route\RuleItem;
...
if (!function_exists('app')) {
     ...
     * @return object
     */
    function app($name = 'app\kernel\App', $args = [], $newInstance = false)
    {
...
if (!function_exists('exception')) {
    ...
    {
        $e = $exception ?: '\app\kernel\Exception';
...
if (!function_exists('json')) {
    /**
     * 获取\app\kernel\response\Json对象实例
     * @param mixed   $data 返回的数据
     * @param integer $code 状态码
     * @param array   $header 头部
     * @param array   $options 参数
     * @return \app\kernel\response\Json
     */
...
if (!function_exists('jsonp')) {
    /**
     * 获取\app\kernel\response\Jsonp对象实例
     * @param mixed   $data    返回的数据
     * @param integer $code    状态码
     * @param array   $header 头部
     * @param array   $options 参数
     * @return \app\kernel\response\Jsonp
     */
...
if (!function_exists('redirect')) {
    /**
     * 获取\app\kernel\response\Redirect对象实例
...
if (!function_exists('trace')) {
     ...
     * @return array|void
     */
    function trace($log = '[app]', $level = 'log')
    {
        if ('[app]' === $log) {
            return Log::getLog();
        } else {
...
if (!function_exists('view')) {
     ...
     * @return \app\kernel\response\View
     */
...
if (!function_exists('xml')) {
    /**
     * 获取\app\kernel\response\Xml对象实例
     * @param mixed   $data    返回的数据
     * @param integer $code    状态码
     * @param array   $header  头部
     * @param array   $options 参数
     * @return \app\kernel\response\Xml
     */
