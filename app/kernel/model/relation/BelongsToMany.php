...
namespace app\kernel\model\relation;
...
class BelongsToMany extends Relation
{
    ...
    {
        $class = $this->pivotName ?: '\\app\\kernel\\model\\Pivot';
        $pivot = new $class($data, $this->parent, $this->middle);
        if ($pivot instanceof Pivot) {
            return $pivot;
        } else {
            throw new Exception('pivot model must extends: \app\kernel\model\Pivot');
        }
    }
    ...
    public function eagerlyResult(&$result, $relation, $subRelation, $closure)
    {
        ...
        if (isset($result->$pk)) {
            ...
            $result->setRelation(parse_name($relation), $this->resultSetBuild($data[$pk]));
        }
    }
