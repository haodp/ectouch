...
use app\kernel\route\dispatch\Callback as CallbackDispatch;
use app\kernel\route\dispatch\Controller as ControllerDispatch;
use app\kernel\route\dispatch\Module as ModuleDispatch;
use app\kernel\route\dispatch\Redirect as RedirectDispatch;
use app\kernel\route\dispatch\Response as ResponseDispatch;
use app\kernel\route\dispatch\View as ViewDispatch;
...
abstract class Rule
{
     ...
     * @access protected
     * @param  array             $option
     * @param  \app\kernel\Request    $request
     * @return void
